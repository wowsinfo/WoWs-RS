namespace WRInfo
{
    class Value
    {
        ...
        static public string PlayerClan = "https://api.worldofwarships.{0}/wows/clans/accountinfo/?application_id=" + ApplicationID + "&account_id={1}&fields=clan.tag&extra=clan";
        static public string PlayerRank = "https://api.worldofwarships.{0}/wows/seasons/accountinfo/?application_id=" + ApplicationID + "&account_id={1}&fields=seasons.rank_info.rank";
